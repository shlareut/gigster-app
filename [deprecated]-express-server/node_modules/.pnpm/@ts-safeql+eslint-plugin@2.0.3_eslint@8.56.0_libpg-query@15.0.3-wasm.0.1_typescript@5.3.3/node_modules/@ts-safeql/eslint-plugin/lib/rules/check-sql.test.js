...
const tsconfigRootDir = path_1.default.resolve(__dirname, "../../");
const project = "tsconfig.json";
const filename = path_1.default.join(tsconfigRootDir, "src/file.ts");
const ruleTester = new utils_1.ESLintUtils.RuleTester({
    parser: "@typescript-eslint/parser",
    parserOptions: { project, tsconfigRootDir },
    settings: {},
});
const runMigrations1 = (sql) => sql.unsafe(`
...
`);
ts_eslint_1.RuleTester.describe = mocha_1.describe;
ts_eslint_1.RuleTester.it = mocha_1.it;
ts_eslint_1.RuleTester.describe("check-sql", () => {
    ts_eslint_1.RuleTester.it = mocha_1.it;
    const databaseName = (0, test_utils_1.generateTestDatabaseName)();
    let sql;
    let dropFn;
    ...
    function withConnection(connection, options) {
        return [{ connections: [Object.assign(Object.assign({}, connection), options)] }];
    }
    ruleTester.run("base", _1.default["check-sql"], {
        valid: [
            {
    ...
    ruleTester.run("base with transform", _1.default["check-sql"], {
        valid: [
            {
    ...
    ruleTester.run("connection with tag target", _1.default["check-sql"], {
        valid: [
            {
                name: "tag as sql",
                filename,
    ...
    ruleTester.run("connection with fieldTransform", _1.default["check-sql"], {
        valid: [
            {
    ...
    ruleTester.run("connection with null options", _1.default["check-sql"], {
        valid: [
            {
    ...
    ruleTester.run("strict null check", _1.default["check-sql"], {
        valid: [
            {
                filename,
        ...
        invalid: [
            ...
            },
            {
                ...
                output: "sql<{ middle_name: string; }>`SELECT middle_name FROM caregiver WHERE middle_name IS NOT NULL`",
