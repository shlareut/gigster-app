import VerifyBase from ".pnpm/twilio@4.23.0/node_modules/twilio/lib/rest/VerifyBase";
import Version from ".pnpm/twilio@4.23.0/node_modules/twilio/lib/base/Version";
import { FormListInstance } from ".pnpm/twilio@4.23.0/node_modules/twilio/lib/rest/verify/v2/form";
import { SafelistListInstance } from ".pnpm/twilio@4.23.0/node_modules/twilio/lib/rest/verify/v2/safelist";
import { ServiceListInstance } from ".pnpm/twilio@4.23.0/node_modules/twilio/lib/rest/verify/v2/service";
import { TemplateListInstance } from ".pnpm/twilio@4.23.0/node_modules/twilio/lib/rest/verify/v2/template";
import { VerificationAttemptListInstance } from ".pnpm/twilio@4.23.0/node_modules/twilio/lib/rest/verify/v2/verificationAttempt";
import { VerificationAttemptsSummaryListInstance } from ".pnpm/twilio@4.23.0/node_modules/twilio/lib/rest/verify/v2/verificationAttemptsSummary";
