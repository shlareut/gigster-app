...
exports.normalizeIndent = exports.getOrSetFromMap = exports.getOrSetFromMapWithEnabled = exports.assertNever = exports.objectKeysNonEmpty = exports.objectKeys = exports.isNonEmpty = exports.groupBy = exports.validateOneOf = exports.fmap = exports.isDefined = void 0;
...
function normalizeIndent(template, ...args) {
    ...
    const indent = (_a = nonEmptyLines[0].match(/^\s*/)) === null || _a === void 0 ? void 0 : _a[0];
