...
exports.getNonNullableColumnsTE = void 0;
...
const get_nonnullable_columns_1 = require("./get-nonnullable-columns");
const cases = [
...
exports.getNonNullableColumnsTE = (0, function_1.flow)(libpg_query_1.default.parseQuery, fp_ts_1.taskEither.tryCatchK(function_1.identity, shared_1.InternalError.to), fp_ts_1.taskEither.map(get_nonnullable_columns_1.getNonNullableColumns), fp_ts_1.taskEither.map((set) => Array.from(set)));
for (const { query, expected, only } of cases) {
    ...
    tester(`get non-nullable columns: ${query}`, async () => {
        return (0, function_1.pipe)((0, exports.getNonNullableColumnsTE)(query), fp_ts_1.taskEither.match((error) => assert_1.default.fail(error.message), (result) => assert_1.default.deepEqual(result, expected)))();
    });
}
//# sourceMappingURL=get-nonnullable-columns.test.js.map